...
public class Whisper3 : MonoBehaviour {
	...
	{
		if (ajuda1 == true) {
			GUI.Label (new Rect (400*x,600*y,250*x,120*y), "'De luz as pessoas e elas encontrarao o caminho.'\n Hmmm...", Normalasstext);
		}
		if (ajuda2 == true) {
			GUI.Label (new Rect (400*x,600*y,250*x,120*y), "Tem quatro rodas na sala e passei por quatro salas, incluindo a que estou atualmente...", Normalasstext);
		}
	}
}
